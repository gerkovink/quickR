...
**The course starts at an intermediate level.** At the end of the week, participants will master advanced programming and scripting skills with R. 
...
### Prerequisites
All participants are assumed to be familiar with basic scripting in `R`. If you are in doubt about your skill set, please go over the materials in [this preperatory course](https://www.gerkovink.com/prepR/#exercises).
...
- Part A: Custom functions
    - [Lecture A](Contents/Material/Part E - Functions apply and looping/Lecture_E.html)
    - [Practical A](Contents/Material/Part E - Functions apply and looping/Practical_E_walkthrough.html)
    - [Impractical A](Contents/Material/Part E - Functions apply and looping/Practical_E.html)
- Part B: Pipes & Data visualization
    - [Lecture B](Contents/Material/Part I - Data visualization/Lecture_i.html)
    - [Practical B](Contents/Material/Part I - Data visualization/Practical_i_walkthrough.html)
    - [Impractical B](Contents/Material/Part I - Data visualization/Practical_i.html)
    - [Practical B discussion](https://www.dropbox.com/s/0bn5qbkes0o0kia/Practical%20G%20discussion.mp4?dl=0)
...
- Part C: Model estimation
    - [Lecture C](Contents/Material/Part JK - Model estimation/Lecture_J.html)
    - [Practical C](Contents/Material/Part JK - Model estimation/Practical_J_walkthrough.html)
    - [Impractical C](Contents/Material/Part JK - Model estimation/Practical_J.html)
- Part D: Classification & Clustering
    - [Lecture D](Contents/Material/Part M - Unsupervised learning/Lecture_M.html)
    - [Practical D](Contents/Material/Part M - Unsupervised learning/Practical_M_walkthrough.html)
    - [Impractical D](Contents/Material/Part M - Unsupervised learning/Practical_M.html)
...
I usually adapt the course as we go. To ensure that you work with the latest iteration of the course materials, I advice all course participants to access the materials online. At the end of the course, you can download all course materials [here](Contents/Material/Archive/Course Archive.zip). 
